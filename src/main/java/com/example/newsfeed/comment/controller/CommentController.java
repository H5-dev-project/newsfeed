...
public class CommentController {
    ...
    public ResponseEntity<ResponseDto<CommentResponseDto>> save(@Parameter(hidden = true) @UserSession AuthUsers authUsers, @PathVariable String boardId, @RequestBody CommentSaveRequestDto dto) {
    ...
    public ResponseEntity<ResponseDto<CommentResponseDto>> update(@Parameter(hidden = true) @UserSession AuthUsers authUsers, @PathVariable Long id, @RequestBody CommentUpdateRequestDto dto) {
        return ResponseEntity.ok(commentService.update(id, authUsers.getUserId(), dto));
    }

    @DeleteMapping("/comments/{id}")
    public ResponseEntity<Void> delete(@Parameter(hidden = true) @UserSession AuthUsers authUsers, @PathVariable Long id) {
